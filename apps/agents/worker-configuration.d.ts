/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6d30c9ce8afce1ee994eecb9a9d0f7e0)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PARALLEL_WORKFLOW: Workflow<Parameters<import('./src/index').ChatWorkflow['run']>[0]['payload']>;
	}
}

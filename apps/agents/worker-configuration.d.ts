/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1a5bd941bb93257d45248d5c6c109bf1)
// Runtime types generated with workerd@1.20260219.0 2026-02-21 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ParallelAgent";
	}
	interface Env {
		...
		ParallelAgent: DurableObjectNamespace<import("./src/index").ParallelAgent>;
		PARALLEL_WORKFLOW: Workflow<Parameters<import("./src/index").ParallelWorkflow['run']>[0]['payload']>;
		HYPOTHESIS_WORKFLOW: Workflow<Parameters<import("./src/index").HypothesisWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_API_KEY" | "SYNC_SERVER_URL" | "INTERNAL_API_KEY" | "CONVEX_URL" | "SANDBOX_URL" | "PARALLEL_API_KEY">> {}
}

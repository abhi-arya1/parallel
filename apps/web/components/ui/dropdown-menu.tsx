  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[8rem] overflow-hidden rounded-xl p-1 text-popover-foreground shadow-lg",
          "bg-popover border border-neutral-200 dark:border-neutral-700/50",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "focus:bg-neutral-100 dark:focus:bg-neutral-700/80 focus:text-accent-foreground",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-sm font-medium text-neutral-700 dark:text-neutral-300 data-[inset]:pl-8",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "text-neutral-700 dark:text-neutral-300",
        "focus:bg-neutral-100 dark:focus:bg-neutral-700/80 focus:text-accent-foreground",
        "data-[state=open]:bg-neutral-100 dark:data-[state=open]:bg-neutral-700/80",
        "data-[inset]:pl-8",
        "[&_svg:not([class*='text-'])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
